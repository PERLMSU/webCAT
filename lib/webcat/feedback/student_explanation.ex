defmodule WebCAT.Feedback.StudentExplanation do
  ...
  @required ~w(feedback_id user_id rotation_group_id explanation_id)a
  ...
  """
  def add(rotation_group_id, user_id, feedback_id, explanation_id) do
    %StudentExplanation{}
    |> changeset(%{
  ...
  def delete(rotation_group_id, user_id, feedback_id, explanation_id) do
