            ...
            try:
                if feedback_explanation:
                    ...
                    messages.add_message(self.request, messages.SUCCESS,
                                         'Successfully created explanation for feedback.')
            except Exception as e:
...
class FeedbackView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if classroom != None:
            ...
            groups = RotationGroup.objects.filter(rotation__classroom=classroom,
                                                  rotation__semester=classroom.current_semester.id,
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            draft.save()
            return JsonResponse({'success': True, 'saved_draft': saved_draft, 'student_id': student.id,
